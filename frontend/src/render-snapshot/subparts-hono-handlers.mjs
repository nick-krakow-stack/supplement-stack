...
import demo from '../../../functions/api/modules/demo.ts';
...
import { knowledgeOverviewCacheKey } from '../../../functions/api/modules/knowledge-overview-projection.ts';
...
export function subpartsKnowledgeOverviewCacheKey(requestUrl) {
