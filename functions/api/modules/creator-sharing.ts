...
function creatorMetricPeriod(now = new Date()): CreatorMetricWindow {
  ...
  return {
    publicPeriod: {
      ...
      unique_visitors_definition: 'Erfasst werden nur Besuche mit Zustimmung zur Nutzungsstatistik. Derselbe Browser zählt im Zeitraum einmal. Besuche ohne Zustimmung fehlen. Automatische Aufrufe werden ausgeschlossen, soweit sie erkennbar sind.',
      saves_definition: 'Erfolgreich gespeicherte Empfehlungen. Wiederholte technische Anfragen mit demselben Speichervorgang zählen nicht erneut.',
    },
  ...
  return c.json({
    ...
    period: {
      ...
      definitions: {
        ...
        imported_stacks: 'In diesem Zeitraum neu gespeicherte, weiterhin vorhandene Stacks mit dieser Creator-Herkunft.',
